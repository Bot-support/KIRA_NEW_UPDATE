...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("Hi~", "Hello Friend I Am @JARVIS_SECURITY_BOT")
        result = result.replace("My dear great botmaster, Lyciabot Team.", "Made By @Jarvis_bot_devs")
        result = result.replace("Have the control right.", "My Father Is @jarvis_bot_devs")
        result = result.replace("I was created by Lyciabot Team.", "I was created by @jarvis_bot_devs Team.")
        ...
        result = result.replace("Eliza", "@JARVIS_SECURITY_BOT")
        result = result.replace("Hi~", "Hello Friend I Am @JARVIS_SECURITY_BOT")
        result = result.replace("My dear great botmaster, Lyciabot Team.", "Made By @jarvis_bot_devs")
        result = result.replace("Have the control right.", "My Father Is @jarvis_bot_devs")
        result = result.replace("I was created by Lyciabot Team.", "I was created by @jarvis_bot_devs Team.")
...
async def redaura(client, message):
    ...
    result = result.replace("Eliza", "@JARVIS_SECURITY_BOT")
    result = result.replace("Hi~", "Hello Friend I Am @JARVIS_SECURITY_BOT")
    result = result.replace("My dear great botmaster, Daisybot Team.", "Made By @jarvis_bot_devs")
    result = result.replace("Have the control right.", "My Father Is @Jarvis_bot_devs")
    result = result.replace("I was created by Lyciabot Team.", "I was created by @jarvis_bot_devs Team.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")
